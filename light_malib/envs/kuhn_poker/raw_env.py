...
class KuhnPokerRawEnv:
    
    metadata = {"render_modes": ["human"], "name": "kuhn_poker_open_spiel"}
    ...
    def render(self,mode="human"):
        txt=self.state.observation_tensor(self.curr_player_idx)
        ...
        print('State = ', self.state)       #card of agent 0, card of agent 1, action of agent 0, action of agent 1
        print(str(txt)+"\n")
